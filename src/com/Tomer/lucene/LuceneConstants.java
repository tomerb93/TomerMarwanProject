...
public class LuceneConstants {
	...
	public static final String PG_TITLE = "pgTitle";
	public static final String[] QUERIES = { "world interest rates table", "2008 beijing olympics", "fast cars",
			"clothing sizes", "phases of the moon", "usa population by state", "prime ministers of england",
			"ipod models", "bittorrent clients", "olympus digital slrs", "composition of the sun", "running shoes",
			"fuel consumption", "stock quote tables", "top grossing movies", "nutrition values",
